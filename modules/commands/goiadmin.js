module.exports.config = {
    ...
    if (e.senderID !== a.getCurrentUserID())
        for (const e of g) {
            if (i == e) {
                var r = ["Tag lần nữa bố ban khỏi dùng", " lần nữa tao đấm cho đấy", "Đã bảo đừng tag mà, thích ăn đấm hả😠", "Có chuyện gì thì ib trực tiếp","có việc gì liên hệ qua facebook admin https://www.facebook.com/iamptthanh "];
                a.sendMessage({
