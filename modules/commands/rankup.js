...
module.exports.handleEvent = async function({ api, event, Currencies, Users }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/cache/rankup/.gifkeep`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/.gifkeep`), mentions: [{ tag: name, id: senderID }] };
